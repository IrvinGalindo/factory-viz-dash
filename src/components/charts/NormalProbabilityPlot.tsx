  ...
  if (!allValues || allValues.length < 3) {
    return (
      <Card className="border-border bg-card">
        <CardHeader>
          <CardTitle className="text-xl text-card-foreground">Gráfica de Probabilidad Normal</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <CardHeader>
        <div className="flex items-start justify-between flex-wrap gap-4">
          ...
          <div className="flex flex-col gap-2">
            <Badge variant={isNormal ? "default" : "destructive"} className="flex items-center gap-1">
              {isNormal ? (
                <>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ fontSize: 12, opacity: 0.7 }}>
                      Percentil teórico:{" "}
                      {typeof payload[0]?.payload?.theoretical === "number"
                        ? payload[0].payload.theoretical.toFixed(4)
                        : "-"}
                    </div>
                  </div>
                );
        ...
        <div className="mt-6 space-y-4 text-sm">
          <div
            className={`p-4 rounded-lg border ${
              isNormal ? "bg-green-500/10 border-green-500/20" : "bg-destructive/10 border-destructive/20"
            }`}
          >
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2 text-muted-foreground list-disc list-inside">
                    {n < 30 && <li>Aumentar muestra a ≥ 30 mediciones para mejor evaluación</li>}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2 border-t border-border">
            ...
            <div className="flex items-start gap-2">
              <div
                className="w-8 h-0.5 border-t-2 border-dashed mt-2 flex-shrink-0"
